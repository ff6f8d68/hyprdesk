...
Rectangle {
    ...
    WebEngineView {
        ...
        anchors.fill: parent
        webChannel: channel
        // The package installs a self-contained theme; do not depend on a user home.
        url: "file:///usr/share/sddm/themes/hyprdesk/hyprdesk_web.html"
        onLoadingChanged: {
            if (loadRequest.status === WebEngineView.LoadFailedStatus) {
                console.log("hyprdesk WebEngine load failed", loadRequest.errorString)
            }
